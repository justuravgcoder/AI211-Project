...
# # Function to show sample training of images
...
# # Function to print RGB foreground and Background
...
# # Subclass of Keras that will maintain the learning rate and the epochs for training data
...
# # Creating a function that will used this trained model
...
fpath=r'C:/Users/u2021605/Mango Classifier/Dataset/Classification_dataset/Anwar Ratool/IMG_20210630_102834.jpg'
...
sdir=r'C:/Users/u2021605/Mango Classifier/Dataset/Classification_dataset/'
...
opt = tf.keras.optimizers.Adamax(learning_rate=0.001)  # Change made here
model=Model(inputs=base_model.input, outputs=output)
model.compile(optimizer=opt, loss='categorical_crossentropy', metrics=['accuracy'])  # Change made here


# # Instantiate the callbacks and train the model
...
save_dir = r'C:/Users/u2021605/Mango Classifier/'
subject = 'mangos'
...
# Save the generator, image size, scale, and accuracy
generator = train_gen
scale = 1
